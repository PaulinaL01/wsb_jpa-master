...
1. Korzystajac z przykladowego kodu dla encji AddressEntity utworz warstwy dostepu do danych (Repository, Service, mappery, TOsy, opcjonalnie RESTy - 
2. dla chetnych) dla encji PatientEntity. Spelnione maja byc nasteoujace wymagania:
